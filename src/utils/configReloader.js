...
const CONFIG_MAPPING = [
  ...
  { target: 'defaults.max_tokens', source: 'defaults.maxTokens', default: 64000 },
  { target: 'defaults.thinkingBudget', source: 'defaults.thinkingBudget', default: 1024 },
  { target: 'timeout', source: 'other.timeout', default: 180000 },
  { target: 'skipProjectIdFetch', source: 'other.skipProjectIdFetch', default: true, transform: v => v !== false },
